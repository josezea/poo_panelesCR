...
Ejecución dura aproximadamente 
...
```{r}
setwd("output")
saveRS(df_creacionSegmentos, "df_creacionSegmentos.Rds")
saveRS(df_asignaPanelSegmento, "df_asignaPanelSegmento.Rds")
saveRS(df_correlativaSegmentoPanel, "df_correlativaSegmentoPanel.Rds")
